...
if(isset($_POST['se']))
 {
  ...
  if($sel=="fname")
  {
$q1="select* from bhup where fname='$ty'";
  ...
  while($rows=mysqli_fetch_assoc($result1))
{
 ...
 if($sel=="rn")
  {
$q2="select* from bhup where rn='$ty'";
...
if($sel=="branch")
  {
$q3="select* from bhup where branch='$ty'";
...
if($sel=="semester")
  {
$q4="select* from bhup where semester='$ty'";
...
if($sel=="address")
  {
$q5="select* from bhup where address='$ty'";
